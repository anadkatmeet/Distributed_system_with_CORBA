...
public class GameServerInterfaceHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, GameServerIDL.GameServerInterface t)
    {
     ...
     */
    public static GameServerIDL.GameServerInterface extract( org.omg.CORBA.Any a )
    {
        ...
        try
        {
            return GameServerIDL.GameServerInterfaceHelper.narrow( a.extract_Object() );
        }
    ...
    private final static String _id = "IDL:GameServerIDL/GameServerInterface:1.0";
     ...
     */
    public static GameServerIDL.GameServerInterface read(org.omg.CORBA.portable.InputStream istream)
    {
        return(GameServerIDL.GameServerInterface)istream.read_Object(GameServerIDL._GameServerInterfaceStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, GameServerIDL.GameServerInterface value)
    {
